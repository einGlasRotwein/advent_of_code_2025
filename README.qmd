...
Here's my past performance (and this year's performance, so far). Note that in 2025, there were 12 instead of 25 puzzles (i.e., 24 instead of 50 gold stars to earn).
